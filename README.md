...
[![Ask Us Anything
!](https://img.shields.io/badge/Ask%20us-anything-1abc9c.svg)](https://github.com/open-AIMS/toxtools/issues/new)
[![R-CMD-check](https://github.com/open-AIMS/toxtools/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/open-AIMS/toxtools/actions/workflows/R-CMD-check.yaml)
[![Codecov test
coverage](https://codecov.io/gh/open-AIMS/toxtools/graph/badge.svg)](https://app.codecov.io/gh/open-AIMS/toxtools)
<!-- badges: end -->
...
is resumed by calling `run_workbook()` again.
...
`bayesnec`, `brms`, `readxl`, `ggplot2` and `quarto` are needed for
this, and `shiny`, `bslib`, `DT` and `callr` for the app. All are
declared in `Suggests`, so installing `toxtools` does not install them.
The PDF report also needs a LaTeX installation;
`tinytex::install_tinytex()` provides one, or choose the web page format
instead.
